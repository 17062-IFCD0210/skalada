...
<div id="page-wrapper">
	...
	<div class="row">
		...
		<form class="form-horizontal" action="<%=Constantes.CONTROLLER_VIAS%>"
			...
			<div class="form-group">
				...
				<div class="col-md-1">
					<input type="hidden" name="id" value="<%=via.getId()%>"> <input
						type="text" class="form-control" value="<%=via.getId()%>" disabled>
				</div>
			...
			<div class="form-group">
				...
				<label class="control-label col-md-2" for="tipo_escalada">Tipo
					Escalada</label>
				<div class="col-md-2">

...
INSERT INTO `sector` (`id`, `nombre`, `id_zona`, `imagen`, `validado`, `id_usuario`) VALUES
	(1, 'Primer espolón', 1, 'default_sector.jpg', 1, 1),
	(2, 'Tercer espolón', 1, 'default_sector.jpg', 1, 1),
	(3, 'Alluitz', 1, 'default_sector.jpg', 1, 2),
	...
	(9, 'Cara Sur', 4, 'default_sector.jpg', 1, 1),
	(10, 'Cara Oeste', 4, 'default_sector.jpg', 1, 1),
	(12, 'PruebaDegar', 1, 'default_sector.jpg', 1, 2),
	(13, 'PruebaV', 1, 'default_sector.jpg', 1, 1);
...
INSERT INTO `zona` (`id`, `nombre`, `id_usuario`, `validado`, `fecha_creado`, `fecha_modificado`) VALUES
	(1, 'Atxarte', 1, b'1', '2015-10-07 09:47:00', '2015-10-14 09:31:18'),
	...
	(6, 'Vacia', 1, b'1', '2015-10-07 09:47:19', '2015-10-07 13:24:02');

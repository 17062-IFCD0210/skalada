...
public class TestModeloTipoEscalada {
	...
	public void setUp() throws Exception {
		this.te_insert = new TipoEscalada(nombreTipoEscalada);
		this.te_insert.setDescripcion(descripcionTipoEscalada);
		id = modelo.save(this.te_insert);
	}
	...
	public void testInsertar() {
		...
		assertTrue("al insertar un nuevo registro aumenta el ID" + total
				+ total_despues, total == total_despues - 1);
	...
	public void testUpdate() {
		...
		te_get = modelo.getById(te_update.getId());
		assertTrue(id == te_get.getId());

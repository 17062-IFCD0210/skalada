...
/**
 * 
	private static final String RXTIMESTAMP = 
			"\\s*<\\s*tr\\s*>\\s*<\\s*td\\s*>\\s*(\\d*)\\s*<\\s*td\\s*>";
 ...
 */
	...
	public final String getHeader() {
		...
		sbuf.append("<table id=\"table-logs\" "
	...
	public final String format(final LoggingEvent event) {
		...
		Pattern pattern = Pattern.compile(
				this.timestampFormat); // RegEx to find the
														// default timestamp
	...
	public final String getFooter() {
		...
		sbuf.append("<script src="
				+ "\"https://code.jquery.com/jquery-1.11.3.min.js\"><script>"
				+ " " + Layout.LINE_SEP);
		sbuf.append("<script src=\"https://cdn.datatables.net"
				+ "/1.10.9/js/jquery.dataTables.min.js\"><script> "
				+ "" + Layout.LINE_SEP);

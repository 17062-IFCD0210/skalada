...
/**
 * Clase que agrupa los valores constantes a usar
 * 
 * @author Curso
 *
 */
public final class Constantes {
	...
	public static final String CONTROLLER_RECORDAR_PASSWORD = ROOT_APP
			+ "recordar-pass";
	...
	/**
	 * Constructor creado para que Checkstyle deje de joder
	 */
	private Constantes() {
		super();
	}

...
public class Constantes {
	 ...
	 * 
	 */
	public static final String VIEW_BACK_VIAS_FORM = 
										"backoffice/pages/vias/form.jsp";
	/**
	 * 
	 */
	
	public static final String VIEW_BACK_GRADOS_INDEX = 
										"backoffice/pages/grados/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_GRADOS_FORM =
										"backoffice/pages/grados/form.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_TIPO_ESCALADA_INDEX = 
									"backoffice/pages/tipo-escalada/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_TIPO_ESCALADA_FORM =
									"backoffice/pages/tipo-escalada/form.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_ZONAS_INDEX = 
									"backoffice/pages/zonas/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_ZONAS_FORM = 
									"backoffice/pages/zonas/form.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_SECTORES_INDEX = 
									"backoffice/pages/sectores/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_SECTORES_FORM = 
									"backoffice/pages/sectores/form.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_ROLES_INDEX = 
									"backoffice/pages/roles/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_ROLES_FORM = 
									"backoffice/pages/roles/form.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_USUARIOS_INDEX = 
									"backoffice/pages/usuarios/index.jsp";
	/**
	 * 
	 */
	public static final String VIEW_BACK_USUARIOS_FORM = 
									"backoffice/pages/usuarios/form.jsp";
	/**
	 * 
	 */
	//controladores
	 ...
	 * 
	 */
	public static final String CONTROLLER_TIPO_ESCALADA   =
									ROOT_APP + "tipo-escalada";
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public static final String CONTROLLER_ZONAS_JSON      = 
									ROOT_APP + "zonas-json";
	/**
	 * 
	 */
	public static final String CONTROLLER_SECTORES        = 
									ROOT_APP + "sectores";
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public static final String CONTROLLER_USUARIOS        = 
									ROOT_APP + "usuarios";
	/**
	 * 
	 */
	 ...
	 * 
	 */
	public static final String CONTROLLER_FORGOT_PASS     = 
									ROOT_APP + "forgot-pass";
	/**
	 * 
	 */
	//acciones

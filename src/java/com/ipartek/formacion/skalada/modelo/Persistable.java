...
public interface Persistable<T> {
	...
	/**
	 **** READ II **** Recupera una coleccion de Objetos pertenecientes al usuario, 
	 *				   en caso de {@code Usuario} "administrador" recupera todos
	 * @param usuario {@code Usuario} del cual queremos recuperar los objetos

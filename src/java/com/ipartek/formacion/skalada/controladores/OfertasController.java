...
public class OfertasController extends HttpServlet {
	...
	private ModeloOferta modelo = null;
	...
	private void listar(HttpServletRequest request, HttpServletResponse response) {
		request.setAttribute("ofertas", this.modelo.getAll());
	...
	private void detalle(HttpServletRequest request,
			HttpServletResponse response) {
		this.oferta = this.modelo.getById(this.pID);
		request.setAttribute("oferta", this.oferta);
	...
	protected void doPost(HttpServletRequest request,
		...
		if (this.pID == -1) {
			if (this.modelo.save(this.oferta) != -1) {
			...
			if (this.modelo.update(this.oferta)) {

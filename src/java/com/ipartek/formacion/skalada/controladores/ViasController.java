 ...
 */
	...
	private void detalle(HttpServletRequest request,
		...
		request.setAttribute("sectores", this.modeloSector.getAllByZona(
				this.via.getSector().getZona().getId()));
		this.dispatcher = request.getRequestDispatcher(
	...
	private void crearObjetoVia() {
		...
		this.tipoEscalada = (TipoEscalada) 
				this.modeloTipoEscalada.getById(this.pIDTipoEscalada);
	...
	*/
	private void getParametersForm(HttpServletRequest request)
		...
		this.pIDTipoEscalada = Integer.parseInt(
				request.getParameter("tipo_escalada"));

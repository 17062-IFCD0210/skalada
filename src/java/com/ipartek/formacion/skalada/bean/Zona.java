...
public class Zona implements Serializable {
	...
	public String toString() {
		return "Zona [id=" + this.id + ", nombre=" + this.nombre + ", sectores=" + this.sectores + ", usuario=" + this.usuario + ", validado="
				+ this.validado + ", fechaCreado=" + this.fechaCreado + ", fechaModificado=" + this.fechaModificado + "]";
	}
